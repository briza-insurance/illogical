...
describe('Condition Engine', () => {
  ...
  // Note: statement() now validates by compiling, but the bytecode compiler
  // is more permissive than the original Parser. Tests for statement validation
  // have been removed as the bytecode compiler accepts expressions that the
  // original Parser would reject (e.g., expressions with wrong operand counts).
